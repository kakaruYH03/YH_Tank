...
{
    [SerializeField] Button joinButton;     // 방입장
    ...
    private void InitSocket()
    {
        ...
        // Socket.io 이벤트 등록
        socket.On("res_connect", EventConnect);                         // 클라가 서버에 연결되었을때 호출
        ...
        socket.On("res_otherready", EventOtherReady);
        socket.On("res_otherunready", EventOtherUnReady);
    }
    ...
    private void EventConnect(SocketIOEvent e)
    {
        ...
        SetLog("서버에 접속 함. ClientId " + clientId);
